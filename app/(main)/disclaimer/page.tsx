      ...
      <div className="max-w-4xl mx-auto">
        <FadeInUp>
          ...
          <div className="prose prose-lg prose-indigo max-w-none text-textMuted font-body leading-relaxed">
            ...
            <h2 className="text-2xl font-heading font-bold text-primary mt-12 mb-4">1. Non-Government Affiliation</h2>
            <p>
            ...
            <h2 className="text-2xl font-heading font-bold text-primary mt-8 mb-4">2. Service Scope</h2>
            <p>
            ...
            <h2 className="text-2xl font-heading font-bold text-primary mt-8 mb-4">3. No Guarantee of Approval</h2>
            <p>
            ...
            <h2 className="text-2xl font-heading font-bold text-primary mt-8 mb-4">4. Liability</h2>
            <p>
            ...
            <h2 className="text-2xl font-heading font-bold text-primary mt-8 mb-4">5. Pricing</h2>
            <p>

...
export default function NewOCIPage() {
  ...
  return (
    <>
      <section className="pt-32 pb-16 px-4 sm:px-6 lg:px-8 bg-bg-page relative overflow-hidden text-center">
        <FadeInUp>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 gap-12">
          <FadeInUp>
            ...
            <p className="mt-6 text-sm italic text-accent">We will confirm your eligibility during the Document Audit.</p>
          </FadeInUp>

          <FadeInUp delay={0.2}>
            <h2 className="text-2xl font-heading font-bold text-primary mb-6">Pricing</h2>
      ...
      <section className="py-16 bg-[#F5F5F0]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <FadeInUp className="bg-white p-8 sm:p-12 rounded-3xl shadow-lg border border-border">
            <h2 className="text-2xl md:text-3xl font-heading font-bold text-primary mb-8 text-center">Step-by-Step Process</h2>

...
export default function ContactPage() {
  return (
    <section className="pt-32 pb-24 px-4 sm:px-6 lg:px-8 bg-background relative overflow-hidden">
            ...
            <FadeInUp delay={0.1}>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  <div className="w-10 h-10 rounded-full bg-navy/5 text-navy flex items-center justify-center shrink-0 mr-4">
                    <Mail className="w-5 h-5" />
                  </div>
                  <div>
                    <h3 className="font-heading font-bold text-navy mb-1">Email Us</h3>
                    <p className="text-textMuted font-body text-sm mb-1">For general inquiries and support.</p>
                    <a href="mailto:support@flyoci.com" className="text-saffron font-medium hover:underline">support@flyoci.com</a>
                  </div>
                </div>

                <div className="flex items-start">
                  <div className="w-10 h-10 rounded-full bg-[#25D366]/10 text-[#25D366] flex items-center justify-center shrink-0 mr-4">
                    <MessageCircle className="w-5 h-5" />
                  </div>
                  <div>
                    <h3 className="font-heading font-bold text-navy mb-1">WhatsApp (Messages Only)</h3>
                    <p className="text-textMuted font-body text-sm mb-1">For quick updates and secure communication.</p>
                    <a href="https://wa.me/447000000000" className="text-[#25D366] font-medium hover:underline">+44 7000 000000</a>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-heading font-bold text-navy mb-1">Business Hours</h3>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-heading font-bold text-navy mb-1">Operations</h3>

        ...
        <div className="max-w-4xl mx-auto text-center">
          <FadeInUp>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold text-navy mb-6 leading-tight">
              Get Your OCI / Visa Documents Checked <span className="text-saffron">Before You Apply</span>
            </h1>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <FadeInUp>
              <h2 className="text-3xl md:text-4xl font-heading font-bold text-navy mb-6">What Is a Document Audit?</h2>
              ...
              <ul className="space-y-4">
                {[
                  ...
                  <li key={i} className="flex items-start text-navy font-body font-medium">
            ...
            <FadeInUp delay={0.2} className="relative">
              <div className="aspect-square bg-[#F5F5F0] rounded-3xl p-8 flex items-center justify-center relative overflow-hidden">
                <FileSearch className="w-32 h-32 text-navy opacity-20 relative z-10" />
                <div className="absolute top-1/4 left-1/4 w-32 h-32 bg-saffron rounded-full blur-[60px] opacity-30 animate-pulse" />
                <div className="absolute bottom-1/4 right-1/4 w-32 h-32 bg-teal rounded-full blur-[60px] opacity-30 animate-pulse" style={{ animationDelay: '1s'}} />
              </div>
            </FadeInUp>
          </div>
        </div>
      ...
      <section className="py-20 bg-navy text-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <FadeInUp delay={0.1}>
              <div className="bg-white/10 rounded-2xl p-8 border border-white/20 h-full">
                <div className="flex items-center gap-4 mb-6">
                  <span className="bg-saffron text-navy font-bold text-xl px-4 py-2 rounded-xl">£15</span>
                ...
                <p className="text-gray-300 font-body text-lg leading-relaxed">
                  The £15 fee covers our expert advisory and written report. It is <strong className="text-saffron">fully deducted from your full service fee</strong> when you proceed with any FlyOCI service within 30 days.
                </p>
            ...
            <FadeInUp delay={0.2}>
              <div className="bg-white rounded-2xl p-8 border-l-8 border-saffron h-full text-navy">
                ...
                <ul className="space-y-4 mb-6">
                  ...
                  <li className="flex justify-between items-center bg-saffron/10 p-3 rounded-lg border border-saffron/20 mt-2">
      ...
      <section className="py-20 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <FadeInUp className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-heading font-bold text-navy mb-4">Who Should Take the Audit?</h2>
            ...
            {[
              ...
              <FadeInUp key={i} delay={i * 0.1}>
                <div className="bg-white p-6 rounded-2xl border border-border shadow-sm flex items-start h-full">
                  ...
                  <p className="text-navy font-body font-medium leading-relaxed">{text}</p>
                </div>
              </FadeInUp>
            ))}
          </div>
      ...
      <section className="py-20 bg-[#F5F5F0]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <FadeInUp className="bg-white rounded-3xl p-8 sm:p-12 shadow-xl border border-border">
            <h2 className="text-3xl font-heading font-bold text-navy mb-8 text-center">What You Receive from the Audit</h2>
            <div className="space-y-6">
              {receiveItems.map((item, i) => (
                <div key={i} className="flex items-start">
                  <div className="w-8 h-8 rounded-full bg-teal/10 text-teal flex items-center justify-center shrink-0 mr-4 mt-1">
                    <CheckCircle className="w-4 h-4" />
                  </div>
                  <p className="text-lg text-navy font-body leading-relaxed pt-1 flex-1 pb-6 border-b border-gray-100">{item}</p>
                </div>
              ))}
            </div>

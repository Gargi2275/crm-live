...
export default function Home() {
  const services = [
    ...
    { title: "Indian e-Visa", description: "1-year and 5-year options.", icon: <Globe />, href: "/services/indian-evisa" },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <FadeInUp>
              ...
              <p className="text-xl font-body font-semibold text-saffron mb-8">
            ...
            <FadeInUp delay={0.2} className="relative">
              <div className="bg-white rounded-3xl p-8 sm:p-12 shadow-[0_12px_40px_rgba(15,31,61,0.08)] border border-border relative z-10">
                <h3 className="text-2xl font-heading font-bold text-navy mb-8">Our 3-Step Safety Net</h3>
                <div className="space-y-8">
                  <div className="flex gap-4">
                    <div className="w-8 h-8 rounded-full bg-navy text-white flex items-center justify-center font-bold shrink-0">1</div>
                    <p className="text-textMuted">We review your documents before you pay the full service fee.</p>
                  </div>
                  <div className="flex gap-4">
                    <div className="w-8 h-8 rounded-full bg-saffron text-navy flex items-center justify-center font-bold shrink-0">2</div>
              ...
              <div className="absolute top-10 -right-4 w-full h-full bg-saffron/10 rounded-3xl -z-10" />
            </FadeInUp>
          </div>
        </div>
      </section>

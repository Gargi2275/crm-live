...
export default function IndianEVisaPage() {
  return (
    <section className="pt-32 pb-24 px-4 sm:px-6 lg:px-8 bg-background relative overflow-hidden min-h-[80vh] flex flex-col items-center">
      <div className="max-w-4xl mx-auto text-center w-full">
        ...
        <FadeInUp delay={0.2} className="my-12 grid md:grid-cols-2 gap-8 text-left">
          <div className="bg-navy p-8 rounded-2xl shadow-sm border border-navy text-white text-center">
          ...
          <div className="bg-navy p-8 rounded-2xl shadow-sm border border-navy text-white text-center relative overflow-hidden">
            <div className="absolute top-4 right-[-30px] bg-saffron text-navy text-xs font-bold px-10 py-1 rotate-[45deg] z-10">POPULAR</div>
        ...
        <FadeInUp delay={0.3} className="text-left bg-white p-8 rounded-2xl border border-border mt-8">
           <h3 className="text-xl font-heading font-bold text-navy mb-4">What We Do</h3>
        ...
        <FadeInUp delay={0.4} className="mt-12">
          <Link href="/document-audit">
            <Button className="py-4 px-8 text-lg bg-teal text-white hover:bg-teal/90">Apply for Indian e-Visa</Button>
          </Link>
        </FadeInUp>
      </div>
    </section>

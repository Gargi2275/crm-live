      ...
      <div className="max-w-4xl mx-auto text-center w-full">
        ...
        <FadeInUp delay={0.2} className="my-12 grid md:grid-cols-2 gap-8 text-left">
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-border">
            <h3 className="text-xl font-heading font-bold text-navy mb-4">How We Help You</h3>
          ...
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-border">
            <h3 className="text-xl font-heading font-bold text-navy mb-4">Pricing</h3>
            <p className="text-3xl font-mono font-bold text-navy mb-2">£78</p>
            <p className="text-sm font-body text-textMuted">Service Fee per applicant.</p>
            <p className="text-sm font-body text-saffron font-medium mt-4">*(Document Audit £15 is credited against this fee. You pay £63 at application stage if audit done).</p>
          </div>
        </FadeInUp>

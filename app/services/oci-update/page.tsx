      ...
      <div className="max-w-4xl mx-auto text-center w-full">
        ...
        <FadeInUp delay={0.2} className="my-12 grid md:grid-cols-2 gap-8 text-left">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-border">
            ...
            <p className="text-3xl font-mono font-bold text-navy mb-2">£50</p>
            <p className="text-sm font-body text-textMuted">Service Fee per applicant.</p>
            <p className="text-sm font-body text-saffron font-medium mt-4">*(If you have taken a Document Audit first, the £15 credit is deducted and you pay £35 at this stage).</p>
          </div>
        </FadeInUp>

    ...
    <section className="bg-primary py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        <motion.p 
          ...
          className="text-lg md:text-xl text-gray-300 font-body mb-10 max-w-2xl mx-auto leading-relaxed"
        >
        ...
        >
          <Link href="/document-audit">
            <Button variant="primary" className="text-lg py-4 px-8 shadow-[0_8px_32px_rgba(245,166,35,0.25)] hover:shadow-[0_8px_32px_rgba(245,166,35,0.4)]">
